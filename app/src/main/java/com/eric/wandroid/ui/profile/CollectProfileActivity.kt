...
class CollectProfileActivity : AppCompatActivity() {
    private val viewModel: CollectProfileViewModel by viewModels { CollectProfileViewModelFactory() }
    ...
    private val adapter = CollectProfileAdapter(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_collect_profile)
        bindViews()
        ...
        recyclerView.apply {
            layoutManager = LinearLayoutManager(this@CollectProfileActivity)
            adapter = this@CollectProfileActivity.adapter
        }
    ...
    private fun render(state: CollectProfileUiState) {
        ...
        if (showBlockingState) {
            ...
            emptyMessage.setText(R.string.profile_empty_message)
